...
function NavBar() {
  return (
    <nav className='fixed top-0 w-full dark:bg-[#0B0B0B] bg-[#ededed] z-50 backdrop-blur-xl'>
      <div className='max-w-6xl mx-auto px-6 py-3 sm:py-4 flex items-center justify-between text-xl dark:text-white'>
        ...
        {/* Buttons */}
        <ul className='sm:flex hidden    gap-x-6 bg-[#4075b1] dark:bg-[#111111] dark:border-[#848484] border rounded-full py-3 px-10 text-white'>
