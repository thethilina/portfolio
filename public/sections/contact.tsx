...
<div className='sm:bg-[#f1f1f1] sm:dark:bg-[#181818] rounded-2 w-full border flex  gap-y-10  border-[#7a7a7a] rounded-2xl p-5 sm:p-20  sm:flex flex-col sm:flex-row justify-between   items-center sm:gap-x-15 '>

<div className='flex flex-col items-start  gap-y-5 sm:gap-y-10'>
<h1 className='text-3xl sm:text-5xl'>Let's work <span className='text-[#417CFA]'><br></br> together.</span></h1>
<p className='text-lg'>I'm always interested in hearing about new projects and opportunities.</p>


{/** contact info mobile*/}
    <div className=" sm:hidden  items-center sm:items-start space-y-3 sm:flex-col gap-y-7 rounded-xl sm:text-lg sm:w-full   ">
